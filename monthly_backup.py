...
# Generate and save the Backup Count by Server chart (Minimalist)
...
plt.figure(figsize=(14, 8))
bars = plt.barh(servers, backup_counts, color='#4B286D')
plt.title('Backups by Server')
...
for bar in bars:
    plt.text(bar.get_width() + 0.1, bar.get_y() + bar.get_height() / 2,
             f'{bar.get_width():.0f}', va='center', ha='left', color='#000000', fontsize=10)
