...
utilization_gb = [round(storage_utilization.get(month, 0) / 1073741824, 2) if month in storage_utilization else 0 for month in months]
...
plt.figure(figsize=(14, 8))
plt.barh(servers, backup_counts, color='#4B286D')
