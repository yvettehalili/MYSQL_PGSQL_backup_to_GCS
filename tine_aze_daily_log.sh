...
# Script to check backup logs for tine-payroll-prod-01 for specific servers
...
query="SELECT name, ip, user, pwd, os, frequency, save_path, location, type FROM ti_db_inventory.servers WHERE name IN ('gdefryak10', 'gdefryak11', 'gdefryak12', 'gdefryak13') AND active = 1 AND project = 'tine-payroll-prod-01' ORDER BY location, type, os;"
